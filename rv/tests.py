...
class CmdTests(TestCase):
    ...
    def test_cmd_pages05(self):
        ...
        self.assertEqual('1433,1970,345,57,7092,73', Config.search_cats)
        self.assertEqual('model:25905,model:34361,cat:1277,cat:315,cat:3315,cat:557,cat:7091,tag:38580,tag:3966', Config.blacklist)
